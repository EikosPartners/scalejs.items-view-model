...
function createConnection(connectionObj, connectionEndpointType, viewId, port) {
    ...
    if (connectionObj == null) {
        ...
        connectionObj.Request.prototype = {
            ...
            _notifySubscriptions: function (response) {
        ...
        connectionObj.registerHandler("LoginResponse", function (message) {
            if (message.cookie != null && message.response.toLocaleUpperCase() === "SUCCESS") {
                ...
                try {
                    if (profileJson() == null && message.profile != null && message.profile[PROFILEJSONNAME])
                        profileJson(message.profile[PROFILEJSONNAME]);
                } catch (e) {
                ...
                try {
                    if (userThemeJson() == null && message.theme != null)
                        userThemeJson(message.theme);
                } catch (e) {
    ...
    if (connectionObj.connectionEndpoint != null) {
        ...
        connectionObj.urlSub = isMarketData
            ? urlMarketData.subscribe(function (urlValue) {
