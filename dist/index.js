...
exports.viewModelConstructor = function (containerId, columns, keyFields, selectionOptions, defaultSorting, serverParameters) {
    var createServerConnection = (0, _createViewFactory2.default)(serverParameters);
    var viewModel = (0, _itemsViewModel2.default)(containerId, columns, keyFields, createServerConnection, selectionOptions, defaultSorting);
