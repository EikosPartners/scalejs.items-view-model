...
(function (w, j) {
  var l = "enumerator is disposed",
      ...
      b = null,
      e = true,
      g = { Identity: function Identity(a) {
      return a;
    }, True: function True() {
      return e;
    }, Blank: function Blank() {} },
      i = { Boolean: typeof e === "undefined" ? "undefined" : _typeof(e), Number: _typeof(0), String: _typeof(""), Object: _typeof({}), Undefined: typeof j === "undefined" ? "undefined" : _typeof(j), Function: _typeof(function () {}) },
      d = { createLambda: function createLambda(a) {
      if (a == b) return g.Identity;if ((typeof a === "undefined" ? "undefined" : _typeof(a)) == i.String) if (a == "") return g.Identity;else if (a.indexOf("=>") == -1) {
        var m = new RegExp("[$]+", "g"),
            c = 0,
            j;while (j = m.exec(a)) {
          var e = j[0].length;if (e > c) c = e;
        }for (var f = [], d = 1; d <= c; d++) {
          for (var h = "", l = 0; l < d; l++) {
            h += "$";
          }f.push(h);
        }var n = Array.prototype.join.call(f, ",");return new Function(n, "return " + a);
      } else {
        var k = a.match(/^[(\s]*([^()]*?)[)\s]*=>(.*)/);return new Function(k[1], "return " + k[2]);
      }return a;
      ...
      f = function f(d, _f, g) {
    var c = new u(),
        b = o.Before;this.current = c.current;this.moveNext = function () {
      try {
        switch (b) {case o.Before:
            b = o.Running;d();case o.Running:
  ...
  };c.Utils = {};c.Utils.createLambda = function (a) {
    ...
    var e = i.prototype,
        f;if (i === Array) {
      f = h.prototype;d.defineProperty(e, "getSource", function () {
        return this;
      });
    } else {
      f = c.prototype;d.defineProperty(e, "getEnumerator", function () {
        return c.from(this).getEnumerator();
      });
    }for (var a in f) {
      var g = f[a];if (e[a] == g) continue;if (e[a] != b) {
        a = a + "ByLinq";if (e[a] == g) continue;
      }g instanceof Function && d.defineProperty(e, a, g);
    }
  };c.choice = function () {
    var a = arguments;return new c(function () {
    ...
    var a = arguments;return new c(function () {
      var c = 0;return new f(function () {
        a = a[0] instanceof Array ? a[0] : a[0].getEnumerator != b ? a[0].toArray() : a;
      }, function () {
        if (c >= a.length) c = 0;return this.yieldReturn(a[c++]);
      }, g.Blank);
    });
  };c.empty = function () {
    ...
    if (j == b) return c.empty();if (j instanceof c) return j;if ((typeof j === "undefined" ? "undefined" : _typeof(j)) == i.Number || (typeof j === "undefined" ? "undefined" : _typeof(j)) == i.Boolean) return c.repeat(j, 1);if ((typeof j === "undefined" ? "undefined" : _typeof(j)) == i.String) return new c(function () {
      ...
      if (_typeof(j.length) == i.Number) return new h(j);if (!(j instanceof Object) && d.isIEnumerable(j)) return new c(function () {
        var c = e,
          ...
          if (c) c = a;else b.moveNext();return b.atEnd() ? a : this.yieldReturn(b.item());
        }, g.Blank);
      });if ((typeof Windows === "undefined" ? "undefined" : _typeof(Windows)) === i.Object && _typeof(j.first) === i.Function) return new c(function () {
        var c = e,
            b;return new f(function () {
          b = j.first();
        }, function () {
          if (c) c = a;else b.moveNext();return b.hasCurrent ? this.yieldReturn(b.current) : this.yieldBreak();
        }, g.Blank);
      });
    }return new c(function () {
      var b = [],
        ...
        for (var a in j) {
          var c = j[a];!(c instanceof Function) && Object.prototype.hasOwnProperty.call(j, a) && b.push({ key: a, value: c });
        }
      }, function () {
    ...
    if (d == b) d = "";if (e instanceof RegExp) {
      ...
      var b;return new f(function () {
        ...
        var c = b.exec(h);return c ? this.yieldReturn(c) : a;
      }, g.Blank);
    });
  };c.range = function (e, d, a) {
    if (a == b) a = 1;return new c(function () {
      var b,
          c = 0;return new f(function () {
        b = e - a;
      }, function () {
    ...
    if (a == b) a = 1;return d < e ? new c(function () {
      var b;return new f(function () {
        b = d - a;
      }, function () {
        var c = b += a;return c <= e ? this.yieldReturn(c) : this.yieldBreak();
      }, g.Blank);
    }) : new c(function () {
      var b;return new f(function () {
        b = d + a;
    ...
    b = d.createLambda(b);return new c(function () {
      var d = e,
        ...
        if (d) {
          d = a;c = h;return this.yieldReturn(c);
        }c = b(c);return this.yieldReturn(c);
      }, g.Blank);
    });
  };c.defer = function (a) {
    return new c(function () {
    ...
    var h = this;g = d.createLambda(g);b = d.createLambda(b);return new c(function () {
      var i,
        ...
        while (e) {
          if (i.moveNext()) {
            j.push(i.current());return this.yieldReturn(b(i.current(), k));
    ...
    var h = this;g = d.createLambda(g);b = d.createLambda(b);return new c(function () {
      var j = [],
        ...
        while (e) {
          if (i.moveNext()) {
            var f = b(i.current(), j.length);j.push(i);i = c.from(g(i.current())).getEnumerator();return this.yieldReturn(f);
    ...
    var h = this;return new c(function () {
      var j,
        ...
        while (e) {
          if (i != b) if (i.moveNext()) return this.yieldReturn(i.current());else i = b;if (j.moveNext()) if (j.current() instanceof Array) {
            d.dispose(i);i = c.from(j.current()).selectMany(g.Identity).flatten().getEnumerator();continue;
          } else return this.yieldReturn(j.current());return a;
        }
      }, function () {
        try {
          d.dispose(j);
    ...
    var e = this;b = d.createLambda(b);return new c(function () {
      var c;return new f(function () {
        ...
        var d = c.current();return c.moveNext() ? this.yieldReturn(b(d, c.current())) : a;
      }, function () {
        d.dispose(c);
      });
    });
    ...
    }var j = this;return new c(function () {
      var b,
          c,
          k = e;return new f(function () {
        b = j.getEnumerator();
      }, function () {
        if (k) {
          k = a;if (!h) {
    ...
    e = d.createLambda(e);if (e.length <= 1) return new m(this, b, e);else {
    ...
    var h = this;g = d.createLambda(g);if (e == b) e = function e(b, a) {
      ...
      var k,
          i = j,
          l = 0;return new f(function () {
        k = h.getEnumerator();
      }, function () {
        if (i === j) if (!k.moveNext()) return a;do {
          if (i == b) {
            var f = g(k.current(), l++);i = c.from(f).getEnumerator();
          }if (i.moveNext()) return this.yieldReturn(e(k.current(), i.current()));d.dispose(i);i = b;
        } while (k.moveNext());return a;
      }, function () {
        try {
          d.dispose(k);
        } finally {
    ...
    b = d.createLambda(b);if (b.length <= 1) return new n(this, b);else {
      var e = this;return new c(function () {
        var c,
    ...
    a = d.createLambda(a);var e = this;return new c(function () {
      var c,
          g = 0;return new f(function () {
        c = e.getEnumerator();
      }, function () {
        while (c.moveNext()) {
          var d = a(c.current(), g++);if (d != b) return this.yieldReturn(d);
    ...
    var i = arguments,
        ...
        g = this;if (arguments.length == 2) {
      var h = arguments[0];return new c(function () {
        var i,
            b,
            j = 0;return new f(function () {
          i = g.getEnumerator();b = c.from(h).getEnumerator();
        }, function () {
    ...
    } else return new c(function () {
      var a,
          h = 0;return new f(function () {
        var b = c.make(g).concat(c.from(i).takeExceptLast().select(c.from)).select(function (a) {
        ...
        if (a.all(function (a) {
          ...
          var c = a.select(function (a) {
            return a.current();
          }).toArray();c.push(h++);return this.yieldReturn(e.apply(b, c));
    ...
    var b = arguments,
        a = this;return new c(function () {
      var e,
          g = -1;return new f(function () {
        e = c.make(a).concat(c.from(b).select(c.from)).select(function (a) {
          return a.getEnumerator();
        }).toArray();
      }, function () {
        while (e.length > 0) {
          g = g >= e.length - 1 ? 0 : g + 1;var a = e[g];if (a.moveNext()) return this.yieldReturn(a.current());else {
            a.dispose();e.splice(g--, 1);
          }
        }return this.yieldBreak();
      }, function () {
    ...
    i = d.createLambda(i);h = d.createLambda(h);l = d.createLambda(l);k = d.createLambda(k);var m = this;return new c(function () {
      var o,
          r,
          p = b,
          q = 0;return new f(function () {
        o = m.getEnumerator();r = c.from(n).toLookup(h, g.Identity, k);
      }, function () {
        while (e) {
          if (p != b) {
            var c = p[q++];if (c !== j) return this.yieldReturn(l(o.current(), c));c = b;q = 0;
          }if (o.moveNext()) {
            var d = i(o.current());p = r.get(d).toArray();
          } else return a;
        }
      }, function () {
        d.dispose(o);
    ...
    h = d.createLambda(h);e = d.createLambda(e);j = d.createLambda(j);i = d.createLambda(i);var k = this;return new c(function () {
      var m = k.getEnumerator(),
        ...
        if (m.moveNext()) {
          var b = n.get(h(m.current()));return this.yieldReturn(j(m.current(), b));
        }return a;
      }, function () {
        d.dispose(m);
      });
    ...
    var e = this;if (arguments.length == 1) {
      var g = arguments[0];return new c(function () {
        var i, h;return new f(function () {
          i = e.getEnumerator();
        }, function () {
          if (h == b) {
            if (i.moveNext()) return this.yieldReturn(i.current());h = c.from(g).getEnumerator();
      ...
      var h = arguments;return new c(function () {
        var a;return new f(function () {
          a = c.make(e).concat(c.from(h).select(c.from)).select(function (a) {
            return a.getEnumerator();
          }).toArray();
        }, function () {
          while (a.length > 0) {
            var b = a[0];if (b.moveNext()) return this.yieldReturn(b.current());else {
              b.dispose();a.splice(0, 1);
            }
          }return this.yieldBreak();
        }, function () {
          c.from(a).forEach(d.dispose);
    ...
    var g = this;return new c(function () {
      var j,
        ...
        if (l == h && i.moveNext()) {
          k = e;return this.yieldReturn(i.current());
        }if (j.moveNext()) {
          l++;return this.yieldReturn(j.current());
    ...
    var g = this;return new c(function () {
      var j, i, k, h;return new f(function () {
        if (a instanceof Array || a.getEnumerator != b) k = c.from(c.from(a).toArray());else k = c.make(a);i = g.getEnumerator();if (i.moveNext()) j = i.current();
      }, function () {
        while (e) {
          if (h != b) if (h.moveNext()) return this.yieldReturn(h.current());else h = b;if (j == b && i.moveNext()) {
            j = i.current();h = k.getEnumerator();continue;
          } else if (j != b) {
            var a = j;j = b;return this.yieldReturn(a);
          }return this.yieldBreak();
        }
      }, function () {
        try {
    ...
    var h = this;if (g === j) g = b;return new c(function () {
      var b,
          c = e;return new f(function () {
        b = h.getEnumerator();
      }, function () {
        if (b.moveNext()) {
          c = a;return this.yieldReturn(b.current());
        } else if (c) {
          c = a;return this.yieldReturn(g);
        }return a;
      }, function () {
        d.dispose(b);
      });
    ...
    b = d.createLambda(b);var e = this;return new c(function () {
      var c, g, h;return new f(function () {
        c = e.getEnumerator();
      }, function () {
        while (c.moveNext()) {
          var d = b(c.current());if (h) {
            h = a;g = d;return this.yieldReturn(c.current());
          }if (g === d) continue;g = d;return this.yieldReturn(c.current());
        }return this.yieldBreak();
      }, function () {
        d.dispose(c);
      });
    ...
    b = d.createLambda(b);var g = this;return new c(function () {
      var h, i;return new f(function () {
        h = g.getEnumerator();i = new r(b);c.from(e).forEach(function (a) {
          i.add(a);
        });
      }, function () {
        while (h.moveNext()) {
          var b = h.current();if (!i.contains(b)) {
            i.add(b);return this.yieldReturn(b);
          }
        }return a;
      }, function () {
        d.dispose(h);
      ...
      var h, i, j;return new f(function () {
        ...
        while (h.moveNext()) {
          var b = h.current();if (!j.contains(b) && i.contains(b)) {
            j.add(b);return this.yieldReturn(b);
          }
        }return a;
      }, function () {
        d.dispose(h);
    ...
    b = d.createLambda(b);var g = this;return new c(function () {
      var k, h, i;return new f(function () {
        k = g.getEnumerator();i = new r(b);
      }, function () {
        var b;if (h === j) {
          while (k.moveNext()) {
            b = k.current();if (!i.contains(b)) {
              i.add(b);return this.yieldReturn(b);
            }
    ...
    var b = this;return new c(function () {
      var c;return new f(function () {
        ...
        if (c.length > 0) {
          var b = Math.floor(Math.random() * c.length);return this.yieldReturn(c.splice(b, 1)[0]);
        }return a;
      }, g.Blank);
    });
    ...
    a = d.createLambda(a);var e = this;return new c(function () {
      var c,
          d = 0;return new f(function () {
        c = e.choose(function (e) {
          var c = a(e);if (c <= 0) return b;d += c;return { value: e, bound: d };
        }).toArray();
      }, function () {
        if (c.length > 0) {
          var f = Math.floor(Math.random() * d) + 1,
              e = -1,
              a = c.length;while (a - e > 1) {
            var b = Math.floor((e + a) / 2);if (c[b].bound >= f) a = b;else e = b;
    ...
    var j = this;i = d.createLambda(i);h = d.createLambda(h);if (e != b) e = d.createLambda(e);g = d.createLambda(g);return new c(function () {
      var c;return new f(function () {
        ...
        while (c.moveNext()) {
          return e == b ? this.yieldReturn(c.current()) : this.yieldReturn(e(c.current().key(), c.current()));
        }return a;
      }, function () {
        d.dispose(c);
      });
    ...
    var l = this;j = d.createLambda(j);i = d.createLambda(i);h = d.createLambda(h);var k;if (g == b) {
      ...
      var b,
        ...
        var d;while ((d = b.moveNext()) == e) {
          ...
          } else m = [];return this.yieldReturn(f);
        }return a;
      }, function () {
        d.dispose(b);
      });
    ...
    var b = this;return new c(function () {
      var c;return new f(function () {
        ...
        var b = [],
          ...
          b.push(c.current());if (++d >= e) return this.yieldReturn(b);
    ...
    a = d.createLambda(a);return a(this.scan(c, b, a).last());
    ...
    if (c === j) c = b;if (d != b) return this.where(d).firstOrDefault(b, c);var g,
    ...
    if (c === j) c = b;if (d != b) return this.where(d).lastOrDefault(b, c);var g,
    ...
    if (c === j) c = b;if (f != b) return this.where(f).singleOrDefault(b, c);var g,
        d = a;this.forEach(function (a) {
      if (!d) {
        d = e;g = a;
      } else throw new Error(q);
    ...
    b = d.createLambda(b);var g = this;return new c(function () {
      var c,
        ...
        while (!h) {
          if (c.moveNext()) {
            if (!b(c.current(), i++)) {
              h = e;return this.yieldReturn(c.current());
            }continue;
          } else return a;
        }return c.moveNext() ? this.yieldReturn(c.current()) : a;
      }, function () {
    ...
    if (e == b) e = 1;var g = this;return new c(function () {
      if (e <= 0) return g.getEnumerator();var b,
        ...
        while (b.moveNext()) {
          if (c.length == e) {
            c.push(b.current());return this.yieldReturn(c.shift());
          }c.push(b.current());
        }return a;
      }, function () {
        d.dispose(b);
    ...
    if (e <= 0 || e == b) return c.empty();var g = this;return new c(function () {
      var j,
        ...
        }if (h == b) h = c.from(i).getEnumerator();return h.moveNext() ? this.yieldReturn(h.current()) : a;
      }, function () {
        d.dispose(h);
      });
    });
  };c.prototype.indexOf = function (d) {
    var c = b;if ((typeof d === "undefined" ? "undefined" : _typeof(d)) === i.Function) this.forEach(function (e, b) {
      if (d(e, b)) {
        c = b;return a;
      }
    });else this.forEach(function (e, b) {
      if (e === d) {
        c = b;return a;
      }
    });return c !== b ? c : -1;
  };c.prototype.lastIndexOf = function (b) {
    var a = -1;if ((typeof b === "undefined" ? "undefined" : _typeof(b)) === i.Function) this.forEach(function (d, c) {
      if (b(d, c)) a = c;
    });else this.forEach(function (d, c) {
      if (d === b) a = c;
    });return a;
    ...
    c = d.createLambda(c);b = d.createLambda(b);a = d.createLambda(a);var e = new r(a);this.forEach(function (g) {
      var f = c(g),
          a = b(g),
          d = e.get(f);if (d !== j) d.push(a);else e.add(f, [a]);
    });return new v(e);
    ...
    c = d.createLambda(c);b = d.createLambda(b);a = d.createLambda(a);var e = new r(a);this.forEach(function (a) {
      e.add(c(a), b(a));
    });return e;
  };c.prototype.toJSONString = function (a, c) {
    if ((typeof JSON === "undefined" ? "undefined" : _typeof(JSON)) === i.Undefined || JSON.stringify == b) throw new Error("toJSONString can't find JSON.stringify. This works native JSON support Browser or include json2.js");return JSON.stringify(this.toArray(), a, c);
    ...
    var e = this;b = d.createLambda(b);return new c(function () {
      var c,
        ...
        if (c.moveNext()) {
          b(c.current(), g++);return this.yieldReturn(c.current());
        }return a;
      }, function () {
        d.dispose(c);
      });
    ...
    var i = this,
        c,
        h = a;return new s(function () {
      return new f(function () {
        if (c == b) c = i.getEnumerator();
      }, function () {
        if (h) throw new Error(l);return c.moveNext() ? this.yieldReturn(c.current()) : a;
      }, g.Blank);
    }, function () {
      h = e;d.dispose(c);
    });
    ...
    var j = this,
        h,
        c,
        i = a;return new s(function () {
      var d = -1;return new f(function () {
        if (c == b) {
          c = j.getEnumerator();h = [];
        }
      }, function () {
        if (i) throw new Error(l);d++;return h.length <= d ? c.moveNext() ? this.yieldReturn(h[d] = c.current()) : a : this.yieldReturn(h[d]);
      }, g.Blank);
    }, function () {
      i = e;d.dispose(c);h = b;
    });
    ...
    a = d.createLambda(a);return this.doAction(function (b) {
      (typeof console === "undefined" ? "undefined" : _typeof(console)) !== i.Undefined && console.log(a(b));
    });
  };c.prototype.trace = function (c, a) {
    if (c == b) c = "Trace";a = d.createLambda(a);return this.doAction(function (b) {
      (typeof console === "undefined" ? "undefined" : _typeof(console)) !== i.Undefined && console.log(c, a(b));
    });
  };var k = function k(f, b, c, e) {
    var a = this;a.source = f;a.keySelector = d.createLambda(b);a.descending = c;a.parent = e;
  };k.prototype = new c();k.prototype.createOrderedEnumerable = function (a, b) {
    ...
    var h = this,
      ...
      d = [];c = [];h.source.forEach(function (b, a) {
        d.push(b);c.push(a);
      });var a = p.create(h, b);a.GenerateKeys(d);c.sort(function (b, c) {
        return a.compare(b, c);
      });
    }, function () {
      return e < c.length ? this.yieldReturn(d[c[e++]]) : a;
    }, g.Blank);
  };var p = function p(c, d, e) {
    var a = this;a.keySelector = c;a.descending = d;a.child = e;a.keys = b;
  };p.create = function (a, d) {
    var c = new p(a.keySelector, a.descending, d);return a.parent != b ? p.create(a.parent, c) : c;
    ...
    var a = this,
        c = d.compare(a.keys[e], a.keys[f]);return c == 0 ? a.child != b ? a.child.compare(e, f) : d.compare(e, f) : a.descending ? -c : c;
  };var s = function s(a, b) {
    this.dispose = b;c.call(this, a);
  };s.prototype = new c();var h = function h(a) {
    ...
    var b = this.getSource();return 0 <= a && a < b.length ? b[a] : c.prototype.elementAt.apply(this, arguments);
  };h.prototype.elementAtOrDefault = function (c, a) {
    if (a === j) a = b;var d = this.getSource();return 0 <= c && c < d.length ? d[c] : a;
  };h.prototype.first = function (d) {
    var a = this.getSource();return d == b && a.length > 0 ? a[0] : c.prototype.first.apply(this, arguments);
  };h.prototype.firstOrDefault = function (e, a) {
    if (a === j) a = b;if (e != b) return c.prototype.firstOrDefault.apply(this, arguments);var d = this.getSource();return d.length > 0 ? d[0] : a;
  };h.prototype.last = function (d) {
    var a = this.getSource();return d == b && a.length > 0 ? a[a.length - 1] : c.prototype.last.apply(this, arguments);
  };h.prototype.lastOrDefault = function (e, a) {
    if (a === j) a = b;if (e != b) return c.prototype.lastOrDefault.apply(this, arguments);var d = this.getSource();return d.length > 0 ? d[d.length - 1] : a;
  };h.prototype.skip = function (d) {
    var b = this.getSource();return new c(function () {
      var c;return new f(function () {
        c = d < 0 ? 0 : d;
      }, function () {
        return c < b.length ? this.yieldReturn(b[c++]) : a;
    ...
    if (a == b) a = 1;return this.take(this.getSource().length - a);
    ...
    var d = this.getSource();if (e != b || !(d instanceof Array)) return c.prototype.toJoinedString.apply(this, arguments);if (a == b) a = "";return d.join(a);
  };h.prototype.getEnumerator = function () {
    var a = this.getSource(),
        b = -1;return { current: function current() {
        return a[b];
      }, moveNext: function moveNext() {
        return ++b < a.length;
      }, dispose: g.Blank };
  };var n = function n(b, a) {
    this.prevSource = b;this.prevPredicate = a;
  };n.prototype = new c();n.prototype.where = function (a) {
    a = d.createLambda(a);if (a.length <= 1) {
    ...
    a = d.createLambda(a);return a.length <= 1 ? new m(this.prevSource, this.prevPredicate, a) : c.prototype.select.call(this, a);
  ...
  };var m = function m(c, a, b) {
    this.prevSource = c;this.prevPredicate = a;this.prevSelector = b;
  };m.prototype = new c();m.prototype.where = function (a) {
    a = d.createLambda(a);return a.length <= 1 ? new n(this, a) : c.prototype.where.call(this, a);
  };m.prototype.select = function (a) {
    var b = this;a = d.createLambda(a);if (a.length <= 1) {
    ...
    var d = function d(a, b) {
      return Object.prototype.hasOwnProperty.call(a, b);
        ...
        h = function h(a) {
      return a === b ? "null" : a === j ? "undefined" : _typeof(a.toString) === i.Function ? a.toString() : Object.prototype.toString.call(a);
    },
        m = function m(d, c) {
    ...
    };k.prototype = { addLast: function addLast(c) {
      ...
      var a = this;a.countField = 0;a.entryList = new k();a.buckets = {};a.compareSelector = c == b ? g.Identity : c;
    };l.prototype = { add: function add(i, j) {
        var a = this,
            g = a.compareSelector(i),
            f = h(g),
            c = new m(i, j);if (d(a.buckets, f)) {
          for (var b = a.buckets[f], e = 0; e < b.length; e++) {
            if (a.compareSelector(b[e].key) === g) {
              a.entryList.replace(b[e], c);b[e] = c;return;
            }
          }b.push(c);
        } else a.buckets[f] = [c];a.countField++;a.entryList.addLast(c);
      }, "get": function get(i) {
        var a = this,
            c = a.compareSelector(i),
            g = h(c);if (!d(a.buckets, g)) return j;for (var e = a.buckets[g], b = 0; b < e.length; b++) {
          var f = e[b];if (a.compareSelector(f.key) === c) return f.value;
        }return j;
      }, "set": function set(k, l) {
        var b = this,
            g = b.compareSelector(k),
            j = h(g);if (d(b.buckets, j)) for (var f = b.buckets[j], c = 0; c < f.length; c++) {
          if (b.compareSelector(f[c].key) === g) {
            var i = new m(k, l);b.entryList.replace(f[c], i);f[c] = i;return e;
          }
        }return a;
      }, contains: function contains(j) {
        var b = this,
            f = b.compareSelector(j),
            i = h(f);if (!d(b.buckets, i)) return a;for (var g = b.buckets[i], c = 0; c < g.length; c++) {
          if (b.compareSelector(g[c].key) === f) return e;
        }return a;
      }, clear: function clear() {
        this.countField = 0;this.buckets = {};this.entryList = new k();
      }, remove: function remove(g) {
        var a = this,
            f = a.compareSelector(g),
            e = h(f);if (!d(a.buckets, e)) return;for (var b = a.buckets[e], c = 0; c < b.length; c++) {
          if (a.compareSelector(b[c].key) === f) {
            a.entryList.remove(b[c]);b.splice(c, 1);if (b.length == 0) delete a.buckets[e];a.countField--;return;
          }
        }
        ...
        var d = this;return new c(function () {
          var c;return new f(function () {
            ...
            if (c != b) {
              var d = { key: c.key, value: c.value };c = c.next;return this.yieldReturn(d);
            }return a;
          }, g.Blank);
        });
      } };return l;
  ...
  };t.prototype = new h();if ((typeof define === "undefined" ? "undefined" : _typeof(define)) === i.Function && define.amd) define("linqjs", [], function () {
    return c;
  });else if ((typeof module === "undefined" ? "undefined" : _typeof(module)) !== i.Undefined && module.exports) module.exports = c;else w.Enumerable = c;
})(undefined);